const API_URL = 'https://172.21.243.108:7500/charging_points';
...
async function revokeKey(id) {
    await fetch(`https://172.21.243.108:7500/revoke/${id}`);
...
async function pauseCP(id) {
    ...
    await fetch(`https://172.21.243.108:7500/${endpoint}/${id}`);
